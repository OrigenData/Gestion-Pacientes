		...
		return new Button.Clicked() {
			...
			public void onClicked(Button arg0) {
				...
				if(entryPassword.getText().isEmpty()) {
					...
					dialog = new MessageDialog(window, true, MessageType.WARNING, ButtonsType.CLOSE,"No se ha ingresado la contraseña");
	                ...
	                try {
				        ...
				        dialog = new MessageDialog(window, true, MessageType.WARNING, ButtonsType.CLOSE,"Conectado");
				    	...
				    	dialog = new MessageDialog(window, true, MessageType.WARNING, ButtonsType.CLOSE,"Error en la conexion");
